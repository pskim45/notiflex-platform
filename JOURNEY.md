...
| ch3 | 3.3 기능 추가 | ✅ | 2026-08-04 | `/version` API 추가, `v0.1.1` 롤링 업데이트 및 응답 검증 |
| ch3 | 3.4 CI | ⬜ | | |
| ch3 | 3.5 CI-CD 연결 | ⬜ | | |
| ch4 | 4.2 메트릭 모니터링 | ⬜ | | |
| ch4 | 4.3 로그 수집 | ⬜ | | |
...
|---------|------|----------|
| Go | 1.25 | 최초 구성 |
| Notiflex 이미지 | `v0.1.1` (`sha256:1f0d134869417dd0730e909bb374596d150f99263b923035680ea55871396f80`) | `/version` API 추가 및 Argo CD 롤링 업데이트 |
